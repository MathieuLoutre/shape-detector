(function (root, factory) {
	...
	_angleRange = deg2Rad(45.0);
	_anglePrecision = deg2Rad(2.0);
	_halfDiagonal = Math.sqrt(_squareSize * _squareSize + _squareSize * _squareSize) * 0.5;
	_origin = {
		x: 0,
		y: 0
	};
	...
	ShapeDetector.prototype.spot = function (points, patternName) {
		...
		for (var i = 0; i < this.patterns.length; i++) {
			...
			if (pattern.name.indexOf(patternName) > -1) {
				...
				if (distance < bestDistance && score > 0) {
